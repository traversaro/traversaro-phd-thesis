...
\begin{figure}[t]
\centering
\subfloat[Dataset 1: no added mass]{\includegraphics[width=0.48\textwidth]{images/dataset0107.pdf}
\label{fig:dataset1}}
\subfloat[Dataset 2]{\includegraphics[width=0.48\textwidth]{images/dataset02.pdf}
\label{fig:dataset2}}
 \newline 
\subfloat[Dataset 3]{\includegraphics[width=0.48\textwidth]{images/dataset03.pdf}
\label{fig:dataset3}}
\subfloat[Dataset 4]{\includegraphics[width=0.48\textwidth]{images/dataset04.pdf}
\label{fig:dataset4}}
