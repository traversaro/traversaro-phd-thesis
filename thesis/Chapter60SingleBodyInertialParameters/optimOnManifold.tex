...
%And the gradients computations must take that projection into account, \cite{bouyarmane2012humanoids} explains that problem in great details for robotics problems with free-floating bases.
